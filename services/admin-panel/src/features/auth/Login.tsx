...
export const Login: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // エラー処理
      setError(error.response?.data?.message || 'ログインに失敗しました。認証情報をご確認ください。');
    } finally {
      setIsLoading(false);
    }
  };
        ...
        <form onSubmit={handleSubmit}>
          <Stack spacing={4}>
            <FormControl isInvalid={isEmailInvalid} isRequired>
              ...
              />
              {isEmailInvalid && <FormErrorMessage>メールアドレスは必須です</FormErrorMessage>}
            </FormControl>
            ...
            <FormControl isInvalid={isPasswordInvalid} isRequired>
              ...
              />
              {isPasswordInvalid && <FormErrorMessage>パスワードは必須です</FormErrorMessage>}
            </FormControl>
