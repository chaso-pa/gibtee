						...
						<CardBody>
							...
							<SimpleGrid columns={1} spacing={4}>
								<Box>
									...
									<Text color={order.adminMemo ? "black" : "gray.500"}>
										{order.adminMemo || "メモはありません"}
									</Text>
								</Box>
							</SimpleGrid>
						...
						<CardBody>
							<SimpleGrid columns={{ base: 1, md: 2 }} spacing={4}>
								<Box>
									...
									<Text color={order.shippingCarrier ? "black" : "gray.500"}>
										{order.shippingCarrier || "未設定"}
									</Text>
								</Box>
								<Box>
									<Text fontWeight="bold" fontSize="sm">
								...
								<Box>
									...
									<Text
										color={order.estimatedDeliveryAt ? "black" : "gray.500"}
									>
										{order.estimatedDeliveryAt
											? formatDate(new Date(order.estimatedDeliveryAt))
											: "未設定"}
									</Text>
								</Box>
								<Box>
						...
						<ModalBody>
							...
							<FormControl>
								...
								<Textarea
									...
									onChange={(e) =>
										setStatusForm({ ...statusForm, adminMemo: e.target.value })
									}
...
const ProductImage: React.FC<{ imageId: number; altText: string }> = ({
	imageId,
	altText,
}) => {
