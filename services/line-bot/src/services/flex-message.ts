 ...
 */
export const createImageConversionResultFlex = (originalImageUrl: string, ghibliImageUrl: string): FlexMessage => {
 ...
 */
export const createPaymentMethodSelectionFlex = (orderNumber: string, totalAmount: number): FlexMessage => {
 ...
 */
export const createCreditCardPaymentFlex = (orderNumber: string, stripeUrl: string): FlexMessage => {
 ...
 * 決済完了メッセージを作成
 */
export const createPaymentCompletedFlex = (orderNumber: string): FlexMessage => {
