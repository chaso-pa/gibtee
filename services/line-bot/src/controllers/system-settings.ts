...
export const updateSystemSettings = async (req: Request, res: Response): Promise<void> => {
  try {
    const { isOrderAcceptanceEnabled, orderSuspensionMessage } = JSON.parse(req.body.body);
 ...
 */
export const getOrderAcceptanceStatus = async (_req: Request, res: Response): Promise<void> => {
  try {
